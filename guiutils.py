...
class LaneDetector:
    ...
    def onchange_th_mag_Y(self):
        return self._th_mag_Y 

    def onchange_th_dir_X(self):
        return self._th_mag_X 

    def onchange_th_dir_Y(self):
        return self._th_mag_Y 

    def onchange_th_h_X(self):
        return self._th_h_X 

    def onchange_th_h_Y(self):
        return self._th_h_Y 

    def onchange_th_l_X(self):
        return self._th_l_X 

    def onchange_th_l_Y(self):
        return self._th_l_Y 

    def onchange_th_s_X(self):
        return self._th_s_X 

    def onchange_th_s_Y(self):
        return self._th_s_Y 
